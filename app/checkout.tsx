...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 17, fontFamily: 'DMSans_700Bold', marginBottom: 12, marginTop: 8 },
  section: { borderRadius: 16, borderWidth: 1, padding: 16, marginBottom: 20 },
  field: { marginBottom: 14 },
  label: { fontSize: 13, fontFamily: 'DMSans_500Medium', marginBottom: 6 },
  input: {
    borderWidth: 1,
    borderRadius: 10,
  ...
  orderItemName: { flex: 1, fontSize: 14, marginRight: 8, fontFamily: 'DMSans_400Regular' },
  orderItemDetail: { fontSize: 14, fontFamily: 'DMSans_400Regular' },
  divider: { height: 1, marginVertical: 12 },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  totalLabel: { fontSize: 15, fontFamily: 'DMSans_400Regular' },
  totalAmount: { fontSize: 22, fontFamily: 'DMSans_700Bold' },
  submitBtn: { paddingVertical: 18, borderRadius: 16, alignItems: 'center' },
  submitBtnText: { color: '#fff', fontSize: 17, fontFamily: 'DMSans_700Bold' },
});
